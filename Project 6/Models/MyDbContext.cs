...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-2JOVLJ4;Database=HR_Management_System;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Attendance>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Attendan__3214EC27FCAB7A1F");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Contact__3214EC277434BF00");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Departme__3214EC27936C701D");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Task__3214EC27A8ECA020");
            ...
            entity.HasOne(d => d.Employee).WithMany(p => p.EmpTasks)
                .HasForeignKey(d => d.EmployeeId)
                .HasConstraintName("FK__Task__EmployeeID__49C3F6B7");
        });

        modelBuilder.Entity<Employee>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC2706C6FA68");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Evaluati__3214EC2749820598");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__HR__3214EC274887CCA3");

            entity.ToTable("HR");

            entity.HasIndex(e => e.Email, "UQ__HR__A9D105345B999473").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Managers__3214EC277EF49563");

            entity.HasIndex(e => e.Email, "UQ__Managers__A9D10534622709F1").IsUnique();
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Request___3214EC27804E7A17");
